...
///////////////////////36H=03那㊣米¯VCOM////////////////////////////////
{0x54, 1, {0x00}},                 //Flicker 36H=03那㊣米¯VCOM

{0x55, 1, {0x4B}},                 //Flicker 36H=03那㊣米¯VCOM
...
#ifdef BUILD_LK
	printf("wqcat dxc  ili9806E apex id = 0x%02x, getid=0x%02x\n",id,get_lcd_id());
#endif

	return ((LCM_ID == id) && (get_lcd_id()==1));
...
LCM_DRIVER ili9806E_jingtai_JTD050097B0_BOE_dsi_2_vdo_fwvga_lcm_drv = 
{
    .name			= "ili9806E_jingtai_JTD050097B0_BOE_dsi_2_vdo_fwvga",
