...
{0x40,1,{0x1a}},	// BT	+2.5/-2.5 pump for DDVDH-L
...
{0xA1,1,{0x0a}},	// Gamma 4
{0xA2,1,{0x09}},	// Gamma 8
{0xA3,1,{0x17}},	// Gamma 16
{0xA4,1,{0x07}},	// Gamma 24
{0xA5,1,{0x1d}},	// Gamma 52
{0xA6,1,{0x0a}},	// Gamma 80
{0xA7,1,{0x0b}},	// Gamma 108
{0xA8,1,{0x03}},	// Gamma 147
{0xA9,1,{0x0e}},	// Gamma 175
{0xAA,1,{0x05}},	// Gamma 203
{0xAB,1,{0x01}},	// Gamma 231
{0xAC,1,{0x14}},	// Gamma 239
{0xAD,1,{0x30}},	// Gamma 247
...
static unsigned int lcm_compare_id(void)
{
    ...
    MDELAY(120);
        ...
        Lcd_Log("wqcat  ili9806E_CHUANGLAIYA_KV4075C8L1_IVO_dsi_2_vdo_wvga %s, 0x00=0x%x,0x01=0x%x,0x02=0x%x,id=0x%x,gpio=0x%x\n", __func__, id_high,id_midd,id_low,id,get_lcd_id());
...
LCM_DRIVER ili9806E_CHUANGLAIYA_KV4075C8L1_IVO_dsi_2_vdo_wvga_lcm_drv = 
{
    .name			= "ili9806E_CHUANGLAIYA_KV4075C8L1_IVO_dsi_2_vdo_wvga",
