...
{0x50,1,{0x78}},                 // VGMP
{0x51,1,{0x78}},                 // VGMN
{0x54,1,{0x00}},                   //Flicker {0x52,1,{0x00}},
{0x55,1,{0x31}},                   //Flicker 8c {0x53,1,{0x01}}
{0xA0,1,{0x00}},  // Gamma 0 
{0xA1,1,{0x19}},  // Gamma 4 
{0xA2,1,{0x20}},  // Gamma 8
...
static unsigned int lcm_compare_id(void)
{
    ...
    MDELAY(120);
        ...
        Lcd_Log("wqcat  ili9806E_CHUANGLAIYA_KV4075C8L1_IVO_dsi_2_vdo_wvga %s, 0x00=0x%x,0x01=0x%x,0x02=0x%x,id=0x%x\n", __func__, id_high,id_midd,id_low,id);
...
LCM_DRIVER ili9806E_APEX_A50182N50BIA_BOE_dsi_2_vdo_fwvga_lcm_drv = 
{
    .name			= "ili9806E_APEX_A50182N50BIA_BOE_dsi_2_vdo_fwvga",
